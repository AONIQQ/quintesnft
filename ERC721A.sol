...
contract QuintesNFT is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    string public uriPrefix = "ipfs://YOUR_BASE_URI/";
    string public uriSuffix = ".json";
    string public preRevealMetadataUri = "ipfs://YOUR_PREREVEAL_URI.json";
    ...
    // FCFS = first-come-first-served phase (public leftover pool)

    bytes32 public gtdMerkleRoot; // Merkle root for GTD allowlist

    bool public paused = false;
    bool public revealed = false;
    bool public gtdPhaseActive = false;
    bool public fcfsPhaseActive = false;

    // Phase tracking (for analytics / UI)
    mapping(address => bool) public gtdMinted;
    mapping(address => bool) public fcfsMinted;
    ...
    /**
     * @notice Guaranteed mint phase (GTD).
    ...
    /**
     * @notice First-come-first-served phase (FCFS).
    ...
    /**
     * @notice Owner mint to a single address, arbitrary quantity.
     * Used for company reserve (e.g. 250 NFTs to treasury wallet), special wallets, etc.
     * NOTE: This function does NOT enforce the 1-per-wallet rule on the recipient,
     * so use it carefully for internal / treasury / special cases only.
     */
    ...
    /**
     * @notice Batch airdrop for GTD wallets.
     * Mints 1 NFT to each address.
        ...
        returns (uint256[] memory)
    {
        ...
        uint256 supply = _nextTokenId(); // exclusive upper bound

        while (currentTokenId < supply && ownedTokenIndex < ownerTokenCount) {
            // If you ever introduce burns, you may want to gate with _exists(currentTokenId)
